; ModuleID = 'listing3-m2r.bc'
source_filename = "listing3.c"
...
for.cond30:                                       ; preds = %for.inc48, %for.body29
  %k.0 = phi i32 [ 0, %for.body29 ], [ %inc49, %for.inc48 ]
  %cmp31 = icmp slt i32 %k.0, 10
  br i1 %cmp31, label %for.body32, label %for.end50

for.body32:                                       ; preds = %for.cond30
  br label %for.cond34

for.cond34:                                       ; preds = %for.inc45, %for.body32
  %j33.0 = phi i32 [ 0, %for.body32 ], [ %inc46, %for.inc45 ]
...
for.body36:                                       ; preds = %for.cond34
  ...
  %arrayidx40 = getelementptr inbounds [100 x i32], [100 x i32]* %arrayidx39, i32 0, i32 %j33.0
  ...
  %arrayidx43 = getelementptr inbounds [100 x i32], [100 x i32]* %arrayidx42, i32 0, i32 %j33.0
